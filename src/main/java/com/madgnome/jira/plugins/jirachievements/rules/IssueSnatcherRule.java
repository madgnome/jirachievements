...
public class IssueSnatcherRule extends AbstractRule implements IRule
{
  ...
  public IssueSnatcherRule(JiraAuthenticationContext jiraAuthenticationContext, IUserWrapperDaoService userWrapperDaoService, IAchievementDaoService achievementDaoService, IUserAchievementDaoService userAchievementDaoService, IssueSearcher issueSearcher, ChangeHistoryManager changeHistoryManager)
  {
  ...
  public void check()
  {
    List<Issue> issues = issueSearcher.searchIssues("status WAS Reopened");
